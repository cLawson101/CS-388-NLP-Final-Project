...
data_file_noans = "albert_noans_best_output_model_2.tsv"
print("starting albert_noans best")
c_noans = "python transformer_2.py"
c_noans += " --max_epochs 20"
c_noans += " --data_path new_data/final_albert_noans_eval_model_2.jsonl"
...
c_noans += " >> best_output/%s.csv" % ("albert_noans_best_loss_model_2")
os.system(c_noans)

data_file_blank = "albert_blank_best_output_model_2.tsv"
print("starting albert_blank best")
c_blank = "python transformer_2.py"
c_blank += " --max_epochs 20"
c_blank += " --data_path new_data/final_albert_blank_eval_model_2.jsonl"
...
c_blank += " >> best_output/%s.csv" % ("albert_blank_best_loss_model_2")
os.system(c_blank)
