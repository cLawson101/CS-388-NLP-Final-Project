...
data_file_noans = "roberta_noans_best_output.tsv"
print("starting roberta_noans best")
c_noans = "python transformer.py"
c_noans += " --max_epochs 20"
c_noans += " --data_path new_data/final_roberta_noans_eval.jsonl"
...
c_noans += " >> best_output/%s.csv" % ("roberta_noans_best_loss")
# os.system(c_noans)
print(c_noans)

data_file_blank = "roberta_blank_best_output.tsv"
print("starting roberta_blank best")
c_blank = "python transformer.py"
c_blank += " --max_epochs 20"
c_blank += " --data_path new_data/final_roberta_blank_eval.jsonl"
...
c_blank += " >> best_output/%s.csv" % ("roberta_blank_best_loss")
# os.system(c_blank)
print(c_blank)
