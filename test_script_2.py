            ...
            for nl in nums_layers:
                for dm in d_models:
                    for hs in d_internals:
                        ...
                        command = "python transformer.py --data_path new_data/final_{}_eval.jsonl --lr {} --nhead {} --num_layers {} --d_model {} --hidden_size {} --output_data_path output_data_2/{} >> test_output_2/{}.csv".format(dataset, lr, nh, nl, dm, hs, data_file, dataset)
                        os.system(command)
